...
print("training r-squared score: ", reg.score(feature_train, target_train))

print("test r-squared score: ", reg.score(feature_test, target_test))

######################################
# this section is for ong-term incentive
"""
...
reg.fit(feature_test, target_test) # these 2 lines added later
